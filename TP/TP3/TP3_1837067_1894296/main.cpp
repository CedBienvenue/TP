/*	Fichier : main.cpp
	...
	Question :
	1. Q : Quelle est l’importance de l’utilisation d’un static_cast ?
		R : Elle nous permet de changer la classe d'un objet d'une classe fille à la classe mère pour pouvoir utiliser les méthodes de cette dernière.
	2. Q : Quel effet aura-t-on si on ne le considère pas dans l’implémentation ?
		R : Le compilateur ne nous laissera pas utiliser les méthodes de la classe fille dans la classe mere et signalera une erreur.
*/
/********************************************
